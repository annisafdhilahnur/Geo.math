...
with st.sidebar:
    st.image ("geo.jpeg")
    st.write ("Geo.math merupakan web aplikasi matematika yang diperuntukkan untuk mempermudah dalam perhitungan berbagai bangun geometri")
    if st.button('G.Math Tim'):
...
with tab1:
    ...
    st.header ('Web Geometri Matematika')
